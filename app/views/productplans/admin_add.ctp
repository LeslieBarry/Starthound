...
<h1><?php __('Add Productplan'); ?></h1>
<div class="productFormDiv">
<?php if($prodId)
{	
	 echo $this->Form->create('Productplan',array('action' => 'add/'.$prodId));
}
else
{
	 echo $this->Form->create('Productplan');
}
?>
		...
		<div class="adminformDivHeight mtop30">
			...
			<span class="fleft inputTxtBlue" id="spanPlan" >
				<?php echo $this->Form->input('plan', array('label'=>false, 'class'=>'adminformTxtBox','style'=>'margin-top:-5px;height:20px;'));?>
			</span>
		...
		<div class="adminformDivHeight mtop30">
			...
			<div id="descMaxLimit" class="fleft blackCol">255</div>
		...
		<div class="adminformDivHeight mtop30">
			...
			<div id="planMaxLimit" class="fleft blackCol">255</div>
		...
		<div class="adminformDivHeight mtop30">
				...
				<div id="dvError14" class="fleft alertTxt alert" style="display:none">Please enter Term</div>
		</div>
		<div class="clr"></div>				
