...
<div class="productFormDiv">
	<?php if($catId)
{
	echo $this->Form->create('Product' ,array('action' => 'add/'.$catId,'type' => 'file'));
}
else
{
	...
	<?php ?>			
		<div class="adminformDivHeight mtop30">
			...
			<span class="fleft inputTxtBlue" >
				<?php echo $this->Form->input('category_id',array('label'=>false,'class'=>'adminformTxtBox','style'=>'margin-top:-5px;'));?>
			</span>				
		</div>
		<div class="clr"></div>
